...
if __name__ == "__main__":
    ...
    probabilities = [.05,.15,.25,.3,.35,.4]

    measurements = [random_measurements_prob(n_layers, n_qubits, probability) for probability in probabilities]
    ...
    for probability, measurements in tqdm(zip(probabilities, measurements)):
        ...
        results = multiple_optimization_runs(ansatz, n_qubits, n_layers, measurements, n_shots, post_selected, dir_name, parallel, ham_type, gradient, thetas[:])
